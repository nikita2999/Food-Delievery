          ...
          <ul className='food-items-main'>
              ...
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_1.png" alt="Greek Salad" />
                  </div>
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_2.png" alt="Veg Salad" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_3.png" alt="Clover Salad" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_4.png" alt="Chicken Salad" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_5.png" alt="Lasagna Rolls" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_6.png" alt="Peri Peri Rolls" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_7.png" alt="Chicken Rolls" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_8.png" alt="Veg Rolls" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_9.png" alt="Ripple Ice Cream" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_10.png" alt="Fruit Ice Cream" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_11.png" alt="Jar Ice Cream" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_12.png" alt="Vanilla Ice Cream" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_13.png" alt="Chicken Sandwich" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_14.png" alt="Vegan Sandwich" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_15.png" alt="Grilled Sandwich" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_16.png" alt="Bread Sandwich" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_17.png" alt="Cup Cake" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_18.png" alt="Vegan Cake" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_19.png" alt="Butterscotch Cake" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_20.png" alt="Sliced Cake" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_21.png" alt="Garlic Mushroom" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_22.png" alt="Fried Cauliflower" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_23.png" alt="Mix Veg Pulao" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_24.png" alt="Rice Zucchini" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_25.png" alt="Cheese Pasta" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_26.png" alt="Tomato Pasta" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_27.png" alt="Creamy Pasta" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_28.png" alt="Chicken Pasta" />
                  </div>
                  <div className="flip-card-back">
          ...
          <ul className='food-items-main'>
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_29.png" alt="Buttter Noodles" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_30.png" alt="Veg Noodles" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_31.png" alt="Somen Noodles" />
                  </div>
                  <div className="flip-card-back">
            ...
            <li className='food-items-list'>
              <div className="flip-card">
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src="/src/assets/food_32.png" alt="Cooked Noodles" />
                  </div>
                  <div className="flip-card-back">
